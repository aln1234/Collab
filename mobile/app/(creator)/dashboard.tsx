  ...
  return (
    <ScreenContainer>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Browse campaigns, apply, submit content, and track payment status.</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.cardTitle}>Campaigns coming next</Text>
        <Text style={styles.cardText}>
          The mobile browse/apply flow will connect to the existing backend campaign endpoints later.
        </Text>
      </View>
